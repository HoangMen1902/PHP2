            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="grid lg:grid-cols-2 grid-cols-1">
                    <div class="lg:mb-0 mb-10">
                        <div class="group w-full h-full">
                            <div class="relative h-full">
                                <img src="<?= client_img ?>/Banner/ContactBanner.jpg" style="object-fit: cover; filter: brightness(50%)" alt="ContactUs tailwind section" class="w-full h-full lg:rounded-l-2xl rounded-2xl bg-blend-multiply bg-indigo-700" />
                                <h1 class="font-manrope text-white text-4xl font-bold leading-10 absolute top-11 left-11">Liên hệ chúng tôi</h1>
                                <div class="absolute bottom-0 w-full lg:p-11 p-5">
                                    <div class="bg-white rounded-lg p-6 block">
                                        <a href="javascript:;" class="flex items-center mb-6">
                                            ...
                                            <h5 class="text-black text-base font-normal leading-6 ml-5">0943653646</h5>
                                        </a>
                                        <a href="https://veilmail.io/irish-geoff" class="flex items-center mb-6">
                                            ...
                                            <h5 class="text-black text-base font-normal leading-6 ml-5">menlhpc08492@gmail.com</h5>
                                        </a>
                                        <a href="javascript:;" class="flex items-center">
                                            ...
                                            <h5 class="text-black text-base font-normal leading-6 ml-5">Phường Hưng Thạnh, Thành Phố Cần Thơ</h5>
                                        </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="bg-gray-50 p-5 lg:p-11 lg:rounded-r-2xl rounded-2xl">
                        <h2 class="re-color font-manrope text-4xl font-semibold leading-10 mb-11">Gửi Email cho chúng tôi</h2>
                        <input type="text" class="w-full h-12 text-gray-600 placeholder-gray-400  shadow-sm bg-transparent text-lg font-normal leading-7 rounded-full border border-gray-200 focus:outline-none pl-4 mb-10" placeholder="Họ và tên">
                        ...
                        <input type="text" class="w-full h-12 text-gray-600 placeholder-gray-400 shadow-sm bg-transparent text-lg font-normal leading-7 rounded-full border border-gray-200 focus:outline-none pl-4 mb-10" placeholder="Số điện thoại">
                        <div class="mb-10">
                            <h4 class="text-gray-500 text-lg font-normal leading-7 mb-4">Phương thức liên hệ</h4>
                            <div class="flex">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <label for="radio-group-2" class="flex items-center cursor-pointer text-gray-500 text-base font-normal leading-6">
                                        <span class="border border-gray-300  rounded-full mr-2 w-4 h-4  ml-2 "></span> Điện thoại
                                    </label>
                                </div>
                            </div>
                        </div>
                        <input type="text" class="w-full h-12 text-gray-600 placeholder-gray-400 bg-transparent text-lg shadow-sm font-normal leading-7 rounded-full border border-gray-200 focus:outline-none pl-4 mb-10" placeholder="Tin nhắn">
                        <button class="w-full h-12 text-white text-base font-semibold leading-6 rounded-full transition-all duration-700  re-bg shadow-sm">Gửi</button>
                    </div>
                </div>
        </section>
    </form>
